 ...
 *  - OGG sounds -> flattened into public/assets/scratch/sounds/ + a name manifest
...
const OUT_SOUNDS = "./public/assets/scratch/sounds";
...
function generateSounds() {
    ...
    fs.writeFileSync(path.join(OUT_SOUNDS, "sounds.json"), JSON.stringify(names), "utf-8");
