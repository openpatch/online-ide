...
export class ScratchColorClass extends ObjectClass {
    static __javaDeclarations: LibraryDeclarations = [
        { type: "declaration", signature: "class Color extends Object", comment: "Farbe; Rot-, Grün-, Blauanteil bzw. Farbton, Sättigung und Helligkeit jeweils 0 bis 255" },

        { type: "method", signature: "Color()", native: ScratchColorClass.prototype._c0, comment: "Erzeugt die Farbe Weiß" },
        { type: "method", signature: "Color(string hexCode)", native: ScratchColorClass.prototype._cHex, comment: "Erzeugt eine Farbe aus einem Hex-Code, z.B. #ff0000" },
        { type: "method", signature: "Color(double h)", native: ScratchColorClass.prototype._cHue, comment: "Erzeugt eine Farbe mit dem angegebenen Farbton (0 bis 255)" },
        { type: "method", signature: "Color(double r, double g, double b)", native: ScratchColorClass.prototype._cRGB, comment: "Erzeugt eine Farbe aus Rot-, Grün- und Blauanteil (jeweils 0 bis 255)" },
        { type: "method", signature: "Color(Color c)", native: ScratchColorClass.prototype._cCopy, comment: "Erzeugt eine Kopie der übergebenen Farbe" },

        { type: "method", signature: "int get()", native: ScratchColorClass.prototype._get, comment: "Gibt die Farbe als ganze Zahl zurück" },
        { type: "method", signature: "double getHSB()", native: ScratchColorClass.prototype._getHSB, comment: "Gibt den Farbton zurück (0 bis 255)" },
        { type: "method", signature: "void setHSB(double h)", native: ScratchColorClass.prototype._setHSB1, comment: "Setzt den Farbton (0 bis 255)" },
        { type: "method", signature: "void setHSB(double h, double s, double l)", native: ScratchColorClass.prototype._setHSB3, comment: "Setzt Farbton, Sättigung und Helligkeit (jeweils 0 bis 255)" },
        { type: "method", signature: "void setRGB(double r, double g, double b)", native: ScratchColorClass.prototype._setRGB, comment: "Setzt Rot-, Grün- und Blauanteil (jeweils 0 bis 255)" },
        { type: "method", signature: "void changeColor(double h)", native: ScratchColorClass.prototype._changeColor, comment: "Ändert den Farbton um den angegebenen Wert" },
        { type: "method", signature: "double getRed()", native: ScratchColorClass.prototype._getRed, comment: "Gibt den Rotanteil zurück (0 bis 255)" },
        { type: "method", signature: "double getGreen()", native: ScratchColorClass.prototype._getGreen, comment: "Gibt den Grünanteil zurück (0 bis 255)" },
        { type: "method", signature: "double getBlue()", native: ScratchColorClass.prototype._getBlue, comment: "Gibt den Blauanteil zurück (0 bis 255)" },
        { type: "method", signature: "double getH()", native: ScratchColorClass.prototype._getH, comment: "Gibt den Farbton zurück (0 bis 255)" },
        { type: "method", signature: "double getS()", native: ScratchColorClass.prototype._getS, comment: "Gibt die Sättigung zurück (0 bis 255)" },
        { type: "method", signature: "double getL()", native: ScratchColorClass.prototype._getL, comment: "Gibt die Helligkeit zurück (0 bis 255)" },
    ];
