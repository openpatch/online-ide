...
export class ScratchHitboxClass extends ObjectClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "Shape getShape()", native: ScratchHitboxClass.prototype._getShape, comment: SRC.hitboxGetShapeComment },

        { type: "method", signature: "void translateAndRotateAndResize(double degrees, double originX, double originY, double translateX, double translateY, double size)", native: ScratchHitboxClass.prototype._transform, comment: SRC.hitboxTranslateAndRotateAndResizeComment },
        { type: "method", signature: "boolean contains(double x, double y)", native: ScratchHitboxClass.prototype._contains, comment: SRC.hitboxContainsComment },
        { type: "method", signature: "Bounds getBounds()", native: ScratchHitboxClass.prototype._getBounds, comment: SRC.hitboxGetBoundsComment },
        { type: "method", signature: "boolean intersects(Hitbox hitbox)", native: ScratchHitboxClass.prototype._intersects, comment: SRC.hitboxIntersectsComment },
        { type: "method", signature: "void drawDebug()", native: ScratchHitboxClass.prototype._drawDebug, comment: SRC.hitboxDrawDebugComment },
        { type: "method", signature: "void drawShape()", native: ScratchHitboxClass.prototype._drawShape, comment: SRC.hitboxDrawShapeComment },
    ];
