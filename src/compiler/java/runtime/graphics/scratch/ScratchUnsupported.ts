...
/**
 * The stage of the running program, for the few classes that need it but have
 * no `this.world` to reach it through — Window, mainly.
 */
export function currentScratchStage<T>(): T | undefined {
    return interpreter?.retrieveObject("ScratchStage") as T | undefined;
}
