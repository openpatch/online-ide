...
export class ScratchAnimatedSpriteClass extends ScratchSpriteClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "AnimatedSprite clone()", java: ScratchAnimatedSpriteClass.prototype._mj$clone$AnimatedSprite$, comment: SRC.animatedSpriteCloneComment },
        { type: "method", signature: "String toString()", java: ScratchAnimatedSpriteClass.prototype._mj$toString$String$, comment: SRC.animatedSpriteToStringComment },
        ...
        },
        {
            ...
            comment: SRC.animatedSpriteAddAnimation5Comment,
        },

        { type: "method", signature: "void playAnimation(string name)", native: ScratchAnimatedSpriteClass.prototype._playAnimation, comment: SRC.animatedSpritePlayAnimationComment },
        { type: "method", signature: "void playAnimation(string name, boolean once)", native: ScratchAnimatedSpriteClass.prototype._playAnimationOnce, comment: SRC.animatedSpritePlayAnimation2Comment },
        { type: "method", signature: "void resetAnimation()", native: ScratchAnimatedSpriteClass.prototype._resetAnimation, comment: SRC.animatedSpriteResetAnimationComment },
        { type: "method", signature: "void setAnimationInterval(int interval)", native: ScratchAnimatedSpriteClass.prototype._setAnimationInterval, comment: SRC.animatedSpriteSetAnimationIntervalComment },
        { type: "method", signature: "int getAnimationInterval()", native: ScratchAnimatedSpriteClass.prototype._getAnimationInterval, comment: SRC.animatedSpriteGetAnimationIntervalComment },
        { type: "method", signature: "int getAnimationFrame()", native: ScratchAnimatedSpriteClass.prototype._getAnimationFrame, comment: SRC.animatedSpriteGetAnimationFrameComment },
        { type: "method", signature: "void setAnimationFrame(int frame)", native: ScratchAnimatedSpriteClass.prototype._setAnimationFrame, comment: SRC.animatedSpriteSetAnimationFrameComment },
        { type: "method", signature: "boolean isAnimationPlayed()", native: ScratchAnimatedSpriteClass.prototype._isAnimationPlayed, comment: SRC.animatedSpriteIsAnimationPlayedComment },
    ];
