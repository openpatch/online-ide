...
export class ScratchExceptionClass extends RuntimeExceptionClass {
    ...
    static __javaDeclarations: LibraryDeclarations = [
        { type: "declaration", signature: "class ScratchException extends RuntimeException", comment: "Fehler der Scratch-Bibliothek" },
        { type: "method", signature: "public ScratchException(String message)", native: ThrowableClass.prototype._constructor_m, comment: "Erzeugt einen Fehler mit der angegebenen Meldung" },
        { type: "method", signature: "public String toString()", native: ThrowableClass.prototype._toString, comment: "Gibt den Fehler als Zeichenkette zurück" },
    ];
